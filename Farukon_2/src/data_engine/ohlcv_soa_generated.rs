...
impl<'a> OHLCVSOA<'a> {
    ...
    pub fn create<'bldr: 'args, 'args: 'mut_bldr, 'mut_bldr, A: flatbuffers::Allocator + 'bldr>(
        ...
        if let Some(x) = args.closes {
            builder.add_closes(x);
        }
        if let Some(x) = args.lows {
            builder.add_lows(x);
        }
        if let Some(x) = args.highs {
            builder.add_highs(x);
        }
        if let Some(x) = args.opens {
            builder.add_opens(x);
        }
        if let Some(x) = args.timestamps {
            builder.add_timestamps(x);
        }
        builder.finish()
    }
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OHLCVSOABuilder<'a, 'b, A> {
    ...
    pub fn add_timestamps(
        &mut self,
        timestamps: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u64>>,
    ) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_TIMESTAMPS, timestamps);
    }
    #[inline]
    pub fn add_opens(&mut self, opens: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f64>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_OPENS, opens);
    }
    #[inline]
    pub fn add_highs(&mut self, highs: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f64>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_HIGHS, highs);
    }
    #[inline]
    pub fn add_lows(&mut self, lows: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f64>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_LOWS, lows);
    }
    #[inline]
    pub fn add_closes(&mut self, closes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, f64>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_CLOSES, closes);
    }
    #[inline]
    pub fn add_volumes(&mut self, volumes: flatbuffers::WIPOffset<flatbuffers::Vector<'b, u64>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<_>>(OHLCVSOA::VT_VOLUMES, volumes);
    }
    #[inline]
...
impl<'a> OHLCVListSOA<'a> {
    ...
    pub fn data(&self) -> Option<OHLCVSOA<'a>> {
        ...
        unsafe {
            self._tab
                .get::<flatbuffers::ForwardsUOffset<OHLCVSOA>>(OHLCVListSOA::VT_DATA, None)
        }
    }
}
...
impl<'a: 'b, 'b, A: flatbuffers::Allocator + 'a> OHLCVListSOABuilder<'a, 'b, A> {
    ...
    pub fn add_data(&mut self, data: flatbuffers::WIPOffset<OHLCVSOA<'b>>) {
        self.fbb_
            .push_slot_always::<flatbuffers::WIPOffset<OHLCVSOA>>(OHLCVListSOA::VT_DATA, data);
    }
    #[inline]
    pub fn new(
        _fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    ) -> OHLCVListSOABuilder<'a, 'b, A> {
        let start = _fbb.start_table();
        OHLCVListSOABuilder {
            fbb_: _fbb,
            start_: start,
...
pub fn size_prefixed_root_as_ohlcvlist_soa(
    buf: &[u8],
) -> Result<OHLCVListSOA, flatbuffers::InvalidFlatbuffer> {
...
#[inline]
pub fn finish_size_prefixed_ohlcvlist_soa_buffer<'a, 'b, A: flatbuffers::Allocator + 'a>(
    fbb: &'b mut flatbuffers::FlatBufferBuilder<'a, A>,
    root: flatbuffers::WIPOffset<OHLCVListSOA<'a>>,
) {
